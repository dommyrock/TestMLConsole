...
using TestMLAppML.Model;

namespace TestMLAppML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\dpolzer\Downloads\wikipedia-detox-250-line-data.tsv.txt";
        private static string MODEL_FILEPATH = @"../../../../TestMLAppML.Model/MLModel.zip";
